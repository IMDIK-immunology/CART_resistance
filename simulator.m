...
% Script control parameters
    ...
    RESISTANT_CELL_OCCURRANCE_ITERATION_STAT = true;
...
% Other parameters
    ...
    % LOW_ANTIGEN_TRANSITION_PROBABILITY = 0.000001;
    LOW_ANTIGEN_TRANSITION_PROBABILITY = 0.0000002;
    % LOW_ANTIGEN_TRANSITION_PROBABILITY = 0.00000002;
    HIGH_ANTIGEN_TRANSITION_PROBABILITY = LOW_ANTIGEN_TRANSITION_PROBABILITY;
...
for external_iteration = 1:number_of_external_iterations
    ...
    for iteration = 1:INTERNAL_ITERATION_MAX
        ...
        % The first iteration is without transition, killing etc.
            ...
            % LOW_ANTIGEN_TRANSITION_PROBABILITY = 0.0000002;
                ...
                for c = 1:size(current_population_antigen,1)
                  ...
                  elseif (current_population_antigen(c) <= LOW_ANTIGEN_MAX_VALUE)
                        if ((1.0-rand) <= LOW_ANTIGEN_TRANSITION_PROBABILITY)
                            current_population_antigen(c) = rand*RESISTANT_ANTIGEN_MAX_VALUE;
                       end
                  else
                     if ((1-rand) <= HIGH_ANTIGEN_TRANSITION_PROBABILITY)
